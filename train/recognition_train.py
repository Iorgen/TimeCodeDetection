...
# TODO transfer model definition in one place for train and inference
def train(run_name, start_epoch, stop_epoch):
    model_weigths_dir = '../inference/weights'
    ...
    model.save_weights(os.path.join(model_weigths_dir, 'model_weights.h5' ))
